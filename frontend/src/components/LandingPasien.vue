        ...
        <div id="nav" class="landingUI">
            <b-navbar toggleable="lg" variant="faded" type="light">
                ...
                <b-navbar-nav class="ml-auto">
                    <b-nav-item v-on:click="dataPasien" class="navItem">Hasil Identifikasi</b-nav-item>
                    <b-button class="navItem" variant="success" @click="logout">Logout</b-button>
                </b-navbar-nav>
                </b-collapse>
            </b-navbar>
        </div>
        <div id="landingpasien" class="landingUI text-left">
            <b-card
                overlay
            ...
            >
                <div class="row h-100">
                    <div class="align-items-center d-flex justify-content-center cardContent">
                        <h2>Selamat datang, Pasien {{ currentUser }}</h2>
                    </div>
                </div>
            </b-card>
            <br>
                ...
                <div class="align-items-center d-flex smartDiv">
                    <b-col>
                        <div class="layoutContentLeft">
                            <h3>Anda telah terdaftar sebagai Pasien</h3>
                            <!-- <br>
                            <b-button disabled size="lg" squared @click="dialogRegisterFormVisible = true">Anda telah terdaftar</b-button> -->
                        </div>
                    </b-col>
                    <b-col>
...
export default {
    ...
    mounted() {
        if (localStorage.userType != 'Pasien')
        this.$router.push('/');
